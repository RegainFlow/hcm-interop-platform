...
import { METRICS, PIPELINE_STAGES, RECENT_LOGS, RECONCILIATION_DATA } from './constants';
import { PiBellDuotone, PiMagnifyingGlassDuotone } from 'react-icons/pi';
    ...
    <div className="min-h-screen bg-[#121213] text-white flex font-primary">
      ...
      <main className="ml-64 flex-1 p-8">
        ...
        <header className="flex justify-between items-center mb-10">
          <div>
            <h1 className="text-3xl font-bold mb-2 text-white">Validation Dashboard</h1>
            <p className="text-[#a6a6a6]">SAP Integration Layer • Environment: <span className="text-[#00d6cb] font-mono">PROD-01</span></p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="neon-button px-4 py-2 text-sm font-medium">
              Run Validation
            </button>
          </div>
        </header>
        ...
        <PipelineVisualizer stages={PIPELINE_STAGES} />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
          ...
          <div className="glass-card p-6 flex flex-col justify-center items-center text-center relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-white mb-2">System Health Healthy</h3>
            <p className="text-[#a6a6a6] max-w-sm mb-6">
              All 300+ tables across TE, GL, Payroll, and HRIS are syncing within defined thresholds. Schema normalization active.
            </p>
